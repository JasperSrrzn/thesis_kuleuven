...
embeddings_enta = pd.read_csv('entity_embeddingsa_transe_50.csv')
embeddings_entb = pd.read_csv('entity_embeddingsb_transe_50.csv')
embeddings_rel = pd.read_csv('relation_embeddings_transe_50.csv')
embeddings_rule = pd.read_csv('rule_embeddings_transe_50.csv')
...
test_data = pd.read_csv('test_data_transe_50.csv')
...
for test_sample in range(2000,len(test_data)):
        ...
        try:
            ...
            while actions:
                ...
                if len(list(trigger_nodes))>0:
                    ...
                    pd_results.to_csv('/content/gdrive/My Drive/results_transe_50_new.csv',index=False)
                    break
